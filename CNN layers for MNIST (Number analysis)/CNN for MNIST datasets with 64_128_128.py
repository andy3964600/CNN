...
#_________________________________________________________________
#conv2d_3 (Conv2D)            (None, 3, 3, 64)          147584     
#_________________________________________________________________
...
#1 Conv2D layer as input layer with 64 neural network union
...
#2 Conv2D layer with 128 neural network union
...
#3 Conv2D layer with 128 neural network union

model.add(layers.Conv2D(128,
                        (3,3),
                        activation='relu'))

#The last Conv2D output 3D tensor(shape=(3,3,128)).Next, we need to trans it to next NN.

#We flat the 3D tensor to 1D array (3*3*128=576).

model.add(layers.Flatten())

#1D layers with 128 neural network union.
